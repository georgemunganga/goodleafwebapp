...
export default function EarlyRepaymentCalculator() {
  ...
  const loanInfo = {
    ...
    totalRepayment: activeLoan?.totalRepayment || 11000,
    monthlyPayment: activeLoan?.amountDue || 916.67,
    remainingMonths: activeLoan?.remainingMonths || 12,
        ...
        <main className="flex-1 px-4 py-6">
          <div className="bg-white rounded-2xl border border-slate-100 p-6 text-center">
            ...
            <p className="text-sm text-slate-600 mb-6">
              You need an active loan before you can calculate an early settlement.
            </p>
